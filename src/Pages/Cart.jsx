			...
			<div className="flex h-full flex-col  bg-white justify-center lg:px-56 px-4">
				<div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                  ...
                  cartProducts.length>0?(
                    <>
                {    cartProducts?.map((product) => (<li key={
										product.id
									}
									className="flex py-6">
									...
									<div className="ml-4 flex flex-1 flex-col">
										...
										<div className=" flex gap-x-2 h-[36px] text-sm ">
											{/* quantity  */}
											<div className=" h-full  text-primary font-medium  max-w-[100px] items-center ">
												...
												<div className="">
													<div className="flex py-2  ">
														<div onClick={
															...
															className="flex items-center justify-center flex-1 h-full cursor-pointer border-2">
															<IoMdRemove/>
														</div>
											...
											<div className="flex  justify-end w-full gap-8 items-center ">
												<div className="flex items-end justify-end flex-1 text-sm font-medium flex-col gap-y-1">
													{
													`$ ${
                    ...
                    <div className="flex justify-center items-center h-[300px] flex-col gap-y-4">
                      <p className="text-2xl">Your cart is empty</p>
                       {/* Redirecting to shopping page button */}
                      <Link to="/shop" className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
                                      Shop Now  
                      </Link>
				...
				<div className="border-t border-gray-200 px-4 py-6 sm:px-6">
					...
					<div className="mt-6 space-y-2">
						<a href="#" className="flex items-center justify-center rounded-md border border-transparent bg-red-500 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-red-700 capitalize"
							onClick={clearCart}>
							clear cart
						</a>
